...
def main():
  ...
  X_raw_train=raw_weird[:train]
  X_raw_test=raw_weird[train:train+test]
  y_train=y_weird[:train]
  y_test=y_weird[train:train+test]
...
#Dense(64, activation="sigmoid", kernel_initializer="uniform", input_dim=922)
  ...
  #Formulate as linear regression
