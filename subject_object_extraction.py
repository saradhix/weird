...
def testSVOs():
    ...
    print("--------------------------------------------------")
    tok = nlp(unicode("the annoying person that was my boyfriend hit me"))
    svos = findSVOs(tok)
    printDeps(tok)
    print(svos)
    assert set(svos) == {('that', 'was', 'boyfriend'), ('person', 'hit', 'me')}

    print("--------------------------------------------------")
    tok = nlp(u"the boy raced the girl who had a hat that had spots.")
    svos = findSVOs(tok)
    printDeps(tok)
    print(svos)
    assert set(svos) == {('boy', 'raced', 'girl'), ('who', 'had', 'hat'), ('that', 'had', 'spots')}

    print("--------------------------------------------------")
    tok = nlp(u"he spit on me")
    svos = findSVOs(tok)
    printDeps(tok)
    print(svos)
    ...
    print("--------------------------------------------------")
    tok = nlp(u"he didn't spit on me")
    svos = findSVOs(tok)
    printDeps(tok)
    print(svos)
    assert set(svos) == {('he', '!spit', 'me')}
    ...
    print("--------------------------------------------------")
    tok = nlp(u"the boy raced the girl who had a hat that didn't have spots.")
    svos = findSVOs(tok)
    printDeps(tok)
    print(svos)
    assert set(svos) == {('boy', 'raced', 'girl'), ('who', 'had', 'hat'), ('that', '!have', 'spots')}

    print("--------------------------------------------------")
    tok = nlp(u"he is a nice man that didn't hurt my child and sister")
    svos = findSVOs(tok)
    printDeps(tok)
    print(svos)
    assert set(svos) == {('he', 'is', 'man'), ('that', '!hurt', 'child'), ('that', '!hurt', 'sister')}

    print("--------------------------------------------------")
    tok = nlp(u"he didn't spit on me and my child")
    svos = findSVOs(tok)
    printDeps(tok)
    print(svos)
